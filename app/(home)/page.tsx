...
// Side-effect-only server component: redirects authenticated users to /dashboard.
// Isolated in its own Suspense boundary so the marketing shell can prerender.
