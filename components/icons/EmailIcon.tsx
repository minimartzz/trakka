...
const EmailIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" {...props}>
      <defs>
        <style>
          {`.cls-1{fill:#ffc247}.cls-2{fill:#ffe45c}.cls-8{fill:#f2f6fc}.cls-9{fill:#2b1505}`}
        </style>
      </defs>
      <g id="_10-Email" data-name="10-Email">
        ...
        <g id="_Group_" data-name="&lt;Group&gt;">
          <circle className="cls-8" cx="43" cy="25" r="2" />
          <path className="cls-8" d="M45 9v8a2 2 0 0 1-4 0V9a2 2 0 0 1 4 0z" />
          <path
            className="cls-9"
          ...
          <path
            className="cls-9"
            d="M43 20a3 3 0 0 0 3-3V9a3 3 0 0 0-6 0v8a3 3 0 0 0 3 3zM42 9a1 1 0 0 1 2 0v8a1 1 0 0 1-2 0zM43 28a3 3 0 1 0-3-3 3 3 0 0 0 3 3zm0-4a1 1 0 1 1-1 1 1 1 0 0 1 1-1z"
          />
        </g>
      </g>
    </svg>
